...
export const ClubSetupPage = () => {
  ...
  // 탈퇴/삭제는 동호회 진입 후 UserMenuPanel 에서 처리 — 실수 방지 위해 MY CLUB 에선 제거
  ...
  return (
    <div className="min-h-screen bg-background-dark flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm">
        ...
        {/* 탈퇴/삭제는 동호회 진입 후 설정 또는 UserMenuPanel 에서만 처리 (실수 방지) */}
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center flex-shrink-0">
                  <span className="material-icons text-primary text-base" aria-hidden="true">sports_soccer</span>
                </div>
                ...
                {selectingClubId === club.id ? (
                  ...
                  <span className="material-icons text-white/20 group-hover:text-primary/50 transition-colors flex-shrink-0" aria-hidden="true">
                    chevron_right
                  </span>
                )}
              </div>
